    ...
    return (
        <>
            <Container maxW={'8xl'} p="12" pb={20}>
                <Heading as="h5" color={'blue.400'} fontWeight={700}>Privacy Policy</Heading>
                <VStack paddingTop="40px" spacing="2" alignItems="flex-start">
                    <Heading fontSize={'22px'} fontWeight={400}>Effective Date: 05-03-2023</Heading>
                    <Heading fontSize={'30px'} fontWeight={700}>Your privacy is important to us</Heading>
                    <Text as="p" fontSize="lg">
                        It is Connect2HQ policy to respect your privacy regarding any information we may collect while operating our website. This Privacy Policy applies to
                        <Link
                            as={'span'}
                            position={'relative'}
                            color={'blue.400'}
                ...
                <VStack paddingTop="40px" spacing="2" alignItems="flex-start">
                    <Heading as="h5" fontWeight={700}>Contents</Heading>
                    <Text as="p" fontSize="lg">
                        Click below to jump to any section of this privacy policy
                    </Text>
                    <Text as="p" fontSize="md">
                        <Link color={'blue.400'} fontWeight={700}>1. Website Visitors </Link> <br/>
                        <Link color={'blue.400'} fontWeight={700}>2. Personally-Identifying Information </Link><br/>
                        <Link color={'blue.400'} fontWeight={700}>3. Links To External Sites </Link><br/>
                        <Link color={'blue.400'} fontWeight={700}>4. Protection of Certain Personally-Identifying Information </Link><br/>
                        <Link color={'blue.400'} fontWeight={700}>5. Aggregated Statistics </Link><br/>
                        <Link color={'blue.400'} fontWeight={700}>6. Cookies </Link><br/>
                        <Link color={'blue.400'} fontWeight={700}>7. E-commerce </Link><br/>
                        <Link color={'blue.400'} fontWeight={700}>8. Privacy Policy Changes </Link><br/>
                        <Link color={'blue.400'} fontWeight={700}>9. Contact Information & Credit </Link><br/>
                    </Text>
                </VStack>
...
<br/>
                    <Text as="p" fontSize="lg">
                        Connect2HQ also collects potentially personally-identifying information like Internet Protocol (IP) addresses for logged in users and for users leaving comments on https://Connect2HQ.com blog posts. Connect2HQ only discloses logged in user and commenter IP addresses under the same circumstances that it uses and discloses personally-identifying information as described below.
                    </Text>
...
<br/>
                ...
                <VStack paddingTop="40px" spacing="2" alignItems="flex-start">
                    <Heading as="h5" fontWeight={700}>5. Aggregated Statistics</Heading>
                    <Text as="p" fontSize="lg">
                        Connect2HQ may collect statistics about the behavior of visitors to its website. Connect2HQ may display this information publicly or provide it to others. However, Connect2HQ does not disclose your personally-identifying information.
                    </Text>
                    <Link color={'blue.600'}>Back to table of contents</Link>
                </VStack>
